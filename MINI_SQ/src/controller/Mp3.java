...
public class Mp3 {
	...
	public Mp3() {
		...
		Bgm b16 = new Bgm("자동차출발", ".\\music\\자동차출발.mp3");
		Bgm b17 = new Bgm("자동차도착2", ".\\music\\자동차도착2.mp3");
		Bgm b18 = new Bgm("점프", ".\\music\\점프.mp3");
		Bgm b19 = new Bgm("징검다리깨짐2", ".\\music\\징검다리깨짐2.mp3");
		Bgm b20 = new Bgm("저격총", ".\\music\\저격총.mp3");
